...
\begin{vbframe}{CSOVO with instance-specific costs \href{https://proceedings.mlr.press/v39/lin14.pdf}{\beamergotobutton{Lin et al. 2014}}}
    ...
    \begin{itemize}
        ...
        \item Example continued:
        			...
        			& & $\cv^{(i)}[1]$ & $\tilde{y}^{( i)}$ $[1 \ \text{vs} \ 2]$ & $\cv^{(i)}[2]$ & $\tilde{y}^{( i)}$ $[2 \ \text{vs} \ 3]$ & $\cv^{(i)}[3]$ & $\tilde{y}^{( i)}$ $[1 \ \text{vs} \ 3]}$ \\
        			\hline & $\xv^{(1)}$ & 0 & 1 & 2 & 2 & 3 & 1\\
        			& $\xv^{(2)}$ & 1 & 2 & 0 & 2 & 1 & -\\
                 	& $\xv^{(3)}$ & 2 & 2 & 0 & 2 & 3 & 1\\
                \end{tabular}
            ...
            \vspace{5pt}
                            \begin{tabular}{cc|cccccc}\
        			& & $\cv^{(i)}[1 \ \text{vs} \ 2]$ & $w^{(i)}$ & $\cv^{(i)}[2 \ \text{vs} \ 3]$ & $w^{(i)}$ & $\cv^{(i)}[1 \ \text{vs} \ 3]}$ & $w^{(i)}$ \\
                        			\hline & $\xv^{(1)}$ & 0/2 & 2 & 2/3 & 1 & 0/3 & 3\\
        			& $\xv^{(2)}$ & 1/0 & 1 & 0/1 & 1 & -/- & 0\\
                 	& $\xv^{(3)}$ & 2/0 & 2 & 0/3 & 3 & 2/3 & 1\\
                \end{tabular}
        \end{center}
