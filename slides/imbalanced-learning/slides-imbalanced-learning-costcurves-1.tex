...
\lecturechapter{Evaluation: Cost Curves Part 1}
...
\begin{frame}{visualize cost curve - lower envelope}
    ...
    \begin{itemize}
        ...
        \item<1-> Duality: line in primal space $\rho_{MCE} = (FNR - FPR) \cdot \rp + FPR$ $\Leftrightarrow$ point in dual space: $(FNR - FPR, - FPR)$
