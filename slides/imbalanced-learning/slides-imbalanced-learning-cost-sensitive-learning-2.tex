...
\lecturechapter{Imbalanced Learning: Cost-Sensitive Learning Part 2}
        ...
        \begin{itemize}
            ...
            \item General idea: 
                ...
                \item Example German Credit Task:
                                \begin{figure}[h]
            \centering
            \includegraphics[width=0.85\textwidth]{slides/imbalanced-learning/figure_man/Relabeling_viz.png}
        \end{figure}
...
\begin{vbframe}{MetaCost: Example Continued}
        ...
        \begin{itemize}
            ...
            \item which results in:
             \begin{itemize}
               \item $i^* = \text{good}: (1-\pi_j(\xi)) C(\text{good, bad})$
               \vspace{5pt}
               \item $i^* = \text{bad}: \pi_j(\xi) C(\text{bad, good})$
               \vspace{5pt}
             \end{itemize}
               \vspace{5pt}
