...
\begin{vbframe}{Threshold adjusting: binary case}
    ...
    \begin{itemize}
        ...
        \item Now, train three classifiers with threefold cross-validation and find the best empirical threshold $T$ on the validation sets:
...
%				$g = |\Yspace|$ number of classes
				...
				\textcolor{blue}{\For{$i=1,\ldots,n$}
					\If{$\xi \in \D_m$ for all $m=1,\ldots,M$}
